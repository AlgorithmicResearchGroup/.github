...
- [ML-Research-Agent-Tasks](https://github.com/AlgorithmicResearchGroup/ML-Research-Agent-Tasks)
...
- [ML-Research-Agent-Evals](https://github.com/AlgorithmicResearchGroup/ML-Research-Agent-Evals)
Agent-Eval is a library for evaluating the performance of an agent on ML Research Benchmark tasks

### ARIA
- [ARIA](https://github.com/AlgorithmicResearchGroup/ARIA)
ARIA Benchmarks is a suite of closed-book benchmarks designed to assess an LLMs knowledge and understanding of machine learning research and methodologies

### Agent States
- [Agent-States](https://github.com/AlgorithmicResearchGroup/Agent-States)
Agent States is a library designed to manage the state and decision-making processes of AI agents.


## Featured Open Source Datasets
- [ArXivDLInstruct](https://huggingface.co/datasets/AlgorithmicResearchGroup/ArXivDLInstruct)
ArXivDLInstruct is a dataset designed for instruction tuning on Python research code for pretraining and fine-tuning language models in code generation tasks.

- [ArXiv Research Code](https://huggingface.co/datasets/AlgorithmicResearchGroup/arxiv_research_code)
...
- [ArXiv Python_Research_Code](https://huggingface.co/datasets/AlgorithmicResearchGroup/arxiv_python_research_code)
